...
# %%
train_data = pd.read_csv("E:\\Galaxy\\2022pycharm\\House_prices\\data\\house-prices-advanced-regression-techniques\\train.csv")
test_data = pd.read_csv("E:\\Galaxy\\2022pycharm\\House_prices\\data\\house-prices-advanced-regression-techniques\\test.csv")
test_data
...
submission.to_csv("E:\\Galaxy\\2022pycharm\\House_prices\\submission.csv",index=False)
submission.head()
